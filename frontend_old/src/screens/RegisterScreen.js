...
export default function SignupScreen({ navigation }) {
    ...
    const InputField = ({ label, field, icon, ...props }) => (
    ...
    return (
        <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={S.container}>
            ...
            <ScrollView contentContainerStyle={S.scroll} keyboardShouldPersistTaps="handled">
                ...
                {/* Card */}
                <View style={S.card}>
                    <InputField label="Full Name" field="name" icon="👤" placeholder="e.g. Arjun Sharma" autoCapitalize="words" />
                    <InputField label="Email Address" field="email" icon="📧" placeholder="you@example.com" keyboardType="email-address" autoCapitalize="none" autoCorrect={false} />
                    ...
                    <InputField label="Age" field="age" icon="🎂" placeholder="e.g. 22" keyboardType="numeric" />
