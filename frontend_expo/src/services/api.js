 ...
 * 2. Update EXPO_PUBLIC_API_BASE_URL with your machine's IP
 * 3. Run: npx expo start --clear
 *
 * Finding Your IP:
 * - macOS/Linux: ifconfig | grep "inet " | grep -v 127.0.0.1
 * - Windows: ipconfig | findstr "IPv4"
 * - Or use: Settings > Network > WiFi > Advanced
 */
...
console.log('🔗 Initial API Base URL:', BASE_URL);
console.log('📱 Platform:', Platform.OS);
console.log('🌍 Environment Variable (BASE_URL):', process.env.EXPO_PUBLIC_API_BASE_URL || process.env.EXPO_PUBLIC_API_URL);
console.log('📊 Debug Mode:', process.env.EXPO_PUBLIC_DEBUG);
...
// Resolve a working backend host + attach JWT
