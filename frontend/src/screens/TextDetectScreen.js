...
export default function TextDetectScreen({ navigation }) {
    ...
    const getResultModelTag = () => {
        if (!result?.model_used) return '📝 Text Model';
        if (result.model_used === 'sklearn-lr-pipeline') return '📦 LR Pipeline';
        if (result.model_used === 'keyword') return '📝 Keyword';
        return '📝 Text Model';
    };
            ...
            <ScrollView showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
                ...
                <View style={S.header}>
                    ...
                    <View style={S.headerContent}>
                        ...
                        <Text style={S.subtitle}>Text-based Emotion Detection</Text>
                        <View style={S.modelBadge}>
                            <Text style={S.modelBadgeText}>🧠 Custom Model · 7 Emotions</Text>
                        </View>
                    </View>
                </View>
